    ...
    <div className="bg-gray-100 min-h-screen p-6 bg-gradient-to-r from-green-100  to-orange-100">
      ...
      <div className="text-center py-10 bg-orange-700 text-white">
        <h1 className="text-5xl font-bold">
          Fighting Food Waste, Feeding the Hungry
        </h1>
      ...
      <section className="max-w-4xl mx-auto my-12 text-center">
        ...
        <p className="text-gray-600 mt-4">
          We connect restaurants, hotels, and food businesses with NGOs to
          distribute surplus food to those in need—minimizing waste and fighting
          hunger.
        </p>
      </section>
      ...
      {/* Impact Statistics */}
      <section className="bg-orange-700 text-white py-10 text-center">
      ...
      <section className="text-center my-12">
        ...
        <p className="text-gray-600 mt-4">
          Be a part of the solution. Start donating food today!
        </p>
        <button
